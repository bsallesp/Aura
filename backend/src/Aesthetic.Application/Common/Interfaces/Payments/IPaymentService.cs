...
{
    Task<string> CreatePaymentIntentAsync(decimal amount, string currency, string description, string? connectedAccountId = null, decimal applicationFeeAmount = 0, string? idempotencyKey = null);
